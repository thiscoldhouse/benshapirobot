...
QUOTES = [
    ...
    ' The Palestinian people, who support, fund and execute suicide bombings. The Palestinian people, who dress their toddlers in bomb belts and then take family snapshots.',
    'The Palestinian Arab population is rotten to the core.',
    'There is no doubt that law enforcement should be heavily scrutinizing the membership and administration of mosques.',
    'We can only fight those who share an ideology [Islam] dedicated to our destruction.',
